                              ...
                              <form method="post" action="map">
                                    ...
                                    <div class="col-xs-12 col-md-6 col-lg-3">
                                        <div class="form-group">
                                            <input type="text" name="keyword" class="form-control" id="exampleInputKeyword" placeholder="Keyword"> </div>
                                    </div>
                                    <div class="col-xs-12 col-md-6 col-lg-3">
                                        <div class="form-group">
                                            <input type="text" name="location" class="form-control" id="exampleInputText2" placeholder="Enter Location"> </div>
                                    </div>
                                    <div class="col-xs-12 col-md-6 col-lg-3">
                                        <div class="form-group">
                                   ...
                                   <a href="foodresult" class="btn theme-btn  btn-block">Submit</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6 food-item">
                                    <div class="food-item-wrap">
                                        ...
                                        <div class="content">
                                            <h5><a href="#">{{$food->food_name}}</a></h5>
                                            <div class="product-name">{{$food->food_description}}</div>
                                            <div class="price-btn-block"> <span class="price">$ {{$food->food_price}}</span> <a href="#" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                        </div>
                                        <div class="restaurant-block">
                                            <div class="left">
                                                <a class="pull-left" href="#"> <img src="http://placehold.it/50x46" alt="Restaurant logo"> </a>
                                                <div class="pull-left right-text"> <a href="#">{{$resturants->Subject}}</a> <span>{{$resturants->phone}}</span> </div>
                                            </div>
                                            <div class="right-like-part pull-right"> <i class="fa fa-heart-o"></i> <span>48</span> </div>
                                        </div>
                                    </div>

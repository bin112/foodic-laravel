        ...
        <div class="page-wrapper">
            ...
            <section class="contact-page inner-page">
                <div class="container">
                   ...
                   <form method="post" action="resturant" enctype="multipart/form-data">

                                        @csrf
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Restaurant Name</label>
                                            <input class="form-control " name="Subject" type="text" value="Artisanal kale" id="example-text-input"> <small id="emailHelp" class="form-text text-muted">We"ll never share your email with anyone else.</small> </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Email address</label>
                                            <input type="email" name="Email_address"class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email"> <small class="form-text text-muted">We"ll never share your email with anyone else.</small> </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Phone number</label>
                                            <input class="form-control" name="phone" type="tel" value="1-(555)-555-5555" id="example-tel-input"> <small class="form-text text-muted">We"ll never share your email with anyone else.</small> </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">URL</label>
                                            <input class="form-control" name="url" type="url" value="http://codenpixel.com" id="example-url-input"> <small class="form-text text-muted">We"ll never share your email with anyone else.</small> </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Open Hours</label>
                                            <input class="form-control" name="Open_Hours"value=""> <small class="form-text text-muted">We"ll never share your email with anyone else.</small> </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Closing Hours</label>
                                            <input class="form-control" name="Closing_Hourses" value=""> <small class="form-text text-muted">We"ll never share your email with anyone else.</small> </div>
                                        <div class="form-group">
                                            <label>Open days</label>
                                            <br>
                                            <div class="btn-group" data-toggle="buttons">
                                                <label class="btn theme-btn active">
                                                    <input name="Open_days "type="checkbox" checked>Mon </label>
                                                <label class="btn theme-btn active">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control-file" name="File_input" id="exampleInputFile" aria-describedby="fileHelp"> <small id="fileHelp" class="form-text text-muted">This is some placeholder block-level help text for the above input. It"s a bit lighter and easily wraps to a new line.</small> </div>
                                        <p>

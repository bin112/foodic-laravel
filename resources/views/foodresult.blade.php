@extends('layouts.general')
        <!-- banner part starts -->
        @section('content')
        <form method ="post" action="foodresult">
            @csrf
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 food-item">
                                    <div class="food-item-wrap">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="price-btn-block"> <span class="price">$ {{$food->food_price}}</span> <a href="profile.html" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                        </div>
                                        <div class="restaurant-block">
                                            <div class="left">
                                                <a class="pull-left" href="#"> <img src="http://placehold.it/50x46" alt="Restaurant logo"> </a>
                                                <div class="pull-left right-text"> <a href="#">{{$resturant->subject}}</a> <span>{{$resturant->phone}}</span> </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>       

                                    ...
                                    <div class="form-horizontal contact-form" role="form">
                                        <fieldset>
                                            <div class="row form-group">
                                                <div class="col-xs-6">
                                                    <input class="form-control" id="fname" name="name" type="text" placeholder="First Name *" required=""> </div>
                                                <div class="col-xs-6">
                                                    <input class="form-control" id="lname" name="last_name" type="text" placeholder="Last Name *" required=""> </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col-xs-6">

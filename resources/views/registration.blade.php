                              ...
                              <form method="post" action="registration">
                                 ...
                                 <div class="row"> 
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input class="form-control" name="First_Name"type="text" value="Artisanal kale" id="example-text-input"> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Last Name</label>
                                       <input class="form-control" name="Last_Name"type="text" value="Artisanal kale" id="example-text-input-2"> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Email address</label>
                                       <input type="email" name="Email_address"class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email"> <small id="emailHelp" class="form-text text-muted">We"ll never share your email with anyone else.</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Phone number</label>
                                       <input class="form-control" name="Phone_number"type="tel" value="1-(555)-555-5555" id="example-tel-input-3"> <small class="form-text text-muted">We"ll never share your email with anyone else.</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input type="password" name="Repeat_password" class="form-control" id="exampleInputPassword2" placeholder="Password"> 
                                    </div>
                                 ...
                                 <div class="row">
                                    <div class="col-sm-4">
                                       <p> <input type="Submit" name="" class="btn theme-btn"></p>
                                    </div>
                                 </div>

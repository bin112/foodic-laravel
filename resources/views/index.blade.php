            ...
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="banner-form">
                        <form class="form-inline" action="foodresult" method="POST">
                            @csrf
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">I would like to eat....</label>
                                <div class="form-group">
                                    <input type="text" name="keyword" class="form-control form-control-lg" id="exampleInputAmount" placeholder="I would like to eat...."> </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            ...
                            <div class="content">
                                <h5><a href="profile">The South"s Best Fried Chicken</a></h5>
                            ...
                            <div class="restaurant-block">
                                <div class="left">
                                    <a class="pull-left" href="profile"> <img src="http://placehold.it/50x46" alt="Restaurant logo" /> </a>
                            ...
                            <div class="restaurant-wrap">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                        <h5><a href="profile">Maenaam Thai Restaurant</a></h5> <span>Burgers, American, Sandwiches, Fast Food, BBQ</span>
